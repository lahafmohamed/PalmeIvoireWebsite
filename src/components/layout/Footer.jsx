...
const SOCIAL = [
  {
    name: 'LinkedIn',
    href: 'https://www.linkedin.com/company/palme-ivoire',
    icon: (
  ...
  {
    name: 'Facebook',
    href: 'https://www.facebook.com/palmeivoire',
    icon: (
      <svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor" aria-hidden="true">
      ...
      <div className="footer__inner">
        ...
        <div className="footer__col">
          ...
          <NavLink to="/locations" className="footer__link footer__link--cta">
            {t('footer.locations.viewAll')} →
          </NavLink>
        </div>
      </div>

      <div className="footer__bottom">
        <p>© {year} Palme Ivoire — {t('footer.rights')}</p>
      </div>
    </footer>
  )
}
